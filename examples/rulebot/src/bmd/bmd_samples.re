...
let airplane =
  mk_bmd_concept(
    "airplane",
    Some("business entity"),
    mk_bmd_rec([
      ("airplane id", mk_bmd_string()),
...
let engine =
  mk_bmd_concept(
    "engine",
    None,
    mk_bmd_rec([("pressure ratio", mk_bmd_int()), ("rpm", mk_bmd_int())]),
  );
...
let transaction_concept =
  mk_bmd_concept(
    ...
    Some("business event"),
    mk_bmd_rec([
      /* XXX ("transaction timestamp",mk_bmd_date ()); XXX */
...
let authorization_response_concept =
  mk_bmd_concept(
    ...
    Some("business event"),
    mk_bmd_rec([
      /* XXX ("authorization timestamp",mk_bmd_date ()); XXX */
