...
let intents = [
  ...
  intent(
    "abort",
    ~examples=["abort", "quit", "reset", "I want to stop"],
    (),
  ),
...
let fill_hole = {
  ...
  dialog_node(
    "Fill Hole",
    ~conditions=
      "(#fill || #replace) && intents[0].confidence > 0.9 && @sys-number",
...
let help = {
  ...
  dialog_node(
    ...
    ~text=
      "You can edit any part of the rule by asking 'change' and giving the number of the part to modify.\n"
