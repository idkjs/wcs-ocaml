...
let next_step = x => Yojson.Basic.pretty_to_string(Wcs.json_of_next_step(x));
...
let workspace = x => Yojson.Basic.pretty_to_string(Wcs.json_of_workspace(x));

let input = x => Yojson.Basic.pretty_to_string(Wcs.json_of_input(x));

let entity = x => Yojson.Basic.pretty_to_string(Wcs.json_of_entity(x));

let output = x => Yojson.Basic.pretty_to_string(Wcs.json_of_output(x));
...
let log_entry = x => Yojson.Basic.pretty_to_string(Wcs.json_of_log_entry(x));

let action = x => Yojson.Basic.pretty_to_string(Wcs.json_of_action(x));
